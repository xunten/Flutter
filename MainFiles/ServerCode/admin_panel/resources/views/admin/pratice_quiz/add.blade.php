...
@section('page_title',  __('Label.Add Pratice Question'))
...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">{{__('Label.Add Pratice Question')}}</h1>
...
@section('pagescript')
	<script>
		function save_pratice_question(){
			...
			$.ajax({
				type:'POST',
				url:'{{ route("praticequestion.store") }}',
				data:formData,
				cache:false,
				contentType: false,
				processData: false,
				success:function(resp){
					$("#dvloader").hide();
					get_responce_message(resp, 'save_pratice_question', '{{ route("praticequestion.index") }}');
				},
