...
@section('page_title', __('Label.Contest Leaderboard'))
...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">{{__('Label.Contest Leaderboard')}}</h1>

            <div class="border-bottom row mb-3">
                <div class="col-sm-10">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{__('Label.Dashboard')}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('contests.index')}}">{{__('Label.Contest')}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Contest Leaderboard</li>
                    </ol>
                </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    url:'{{ route("contestleaderboard", [$id]) }}',
                },
                columns: [{
                        data: 'rank',
                        name: 'rank'
