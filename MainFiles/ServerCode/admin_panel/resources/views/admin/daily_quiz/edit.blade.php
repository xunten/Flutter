...
@section('page_title', __('Label.edit_daily_quiz_question'))
...
@section('content')
	...
	<div class="right-content">
		...
		<div class="body-content">
			<!-- mobile title -->
			<h1 class="page-title-sm">{{__('Label.edit_daily_quiz_question')}}</h1>
				...
				<div class="col-sm-10">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">
							{{__('Label.edit_daily_quiz_question')}}
						</li>
					</ol>
				</div>
...
@section('pagescript')
	<script>
		function save_edit_question() {
			...
			$.ajax({
				type: 'POST',
				url:'{{ route("dailyquizquestion.update", [$result->id]) }}',
				data: formData,
				cache: false,
				contentType: false,
				processData: false,
				success: function(resp) {
					$("#dvloader").hide();
					get_responce_message(resp, 'save_edit_question', '{{ route("dailyquizquestion.index") }}');
				},
