...
@section('page_title', __('Label.Daily_Quiz_Leaderboard'))
...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">{{__('Label.Daily_Quiz_Leaderboard')}}</h1>

            <div class="border-bottom row mb-3">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{__('Label.Dashboard')}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{__('Label.Daily_Quiz_Leaderboard')}}</li>
                    </ol>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('dailyquizleaderboard') }}",
                    data: function(d) {
