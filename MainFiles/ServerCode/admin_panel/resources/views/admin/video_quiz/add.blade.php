...
@section('page_title', __('Label.add_video_question'))
...
@section('content')
	...
	<div class="right-content">
		...
		<div class="body-content">
			<!-- mobile title -->
			<h1 class="page-title-sm">{{__('Label.add_video_question')}}</h1>
						...
						<div class="col-md-9">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-8 video_box">
									...
									<input name="video" type="file" class="form-control import-file" accept=".mp4">
									<label class="mt-1 text-gray">Note: Video File size must be less than 5MB. && Video type supported (mp4)</label>
								</div>
								<div class="form-group col-md-8 url_box">
									<label>{{__('Label.url')}}</label>
									<input name="video_url" type="url" class="form-control" placeholder="Enter Video URL">
								</div>
							</div>
		...
		function save_question() {
			...
			$.ajax({
				...
				success: function(resp) {
					$("#dvloader").hide();
					get_responce_message(resp, 'save_question', '{{ route("videoquestion.index") }}');
				},
